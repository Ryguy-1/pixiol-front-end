    ...
    <main>
      <CenterColumn maxWidthRem={60}>
        <div className="flex flex-col items-start gap-5 lg:pt-20">
          <div className="h-[4rem] sm:h-[6rem] md:h-[10rem] w-5/6 rounded-xl animate-pulse bg-gray-600"></div>
          <div className="flex flex-row justify-between w-full">
            ...
            <div className="w-1/6">
              <div className="h-[3rem] w-1/2 rounded-xl animate-pulse bg-gray-600"></div>
            </div>
          </div>
